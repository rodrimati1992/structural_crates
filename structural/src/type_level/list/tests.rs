use crate::type_level::collection_traits::{Append, Flatten, PushBack};
...
#[test]
fn flatten() {
    let _: AssertEq<Flatten<TList![]>, TList![]>;
    let _: AssertEq<Flatten<TList![TList![A]]>, TList![A]>;
    let _: AssertEq<Flatten<TList![TList![A], TList![]]>, TList![A]>;
    let _: AssertEq<Flatten<TList![TList![], TList![A]]>, TList![A]>;
    let _: AssertEq<Flatten<TList![TList![A], TList![B]]>, TList![A, B]>;
    let _: AssertEq<Flatten<TList![TList![A, B], TList![C]]>, TList![A, B, C]>;
    let _: AssertEq<Flatten<TList![TList![A, B], TList![C, D]]>, TList![A, B, C, D]>;
    let _: AssertEq<Flatten<TList![TList![A, B], TList![], TList![C, D]]>, TList![A, B, C, D]>;
    let _: AssertEq<
